  ...
  const handleSocialLogin = async (platform: string) => {
    ...
    setTimeout(async () => {
      try {
        ...
        setError(`Failed to sign in with ${platform}.`);
        setIsSubmitting(false);
      }
    }, 1000);
  };
      ...
      <div className="glass-card w-full max-w-md p-8 rounded-2xl shadow-xl animate-fade-in-up relative z-10">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-slate-900 text-gray-500 rounded-lg">Or continue with</span>
          </div>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-graytext dark:text-gray-400">
